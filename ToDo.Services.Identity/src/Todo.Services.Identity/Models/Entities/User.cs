...
namespace Todo.Services.Identity.Models.Entities
{
    public class User : IIdentifiable
    {
        ...
        public User(Guid id, string email, string role)
        {
            ...
            {
                throw new TodoException(Codes.InvalidEmail,
                    $"Invalid email: '{email}'.");
            }
            if (!Models.Entities.Role.IsValid(role))
            {
                throw new TodoException(Codes.InvalidRole,
                    $"Invalid role: '{role}'.");
            }
            Id = id;
        ...
        public void SetPassword(string password, IPasswordHasher<User> passwordHasher)
        {
            ...
            {
                throw new TodoException(Codes.InvalidPassword,
